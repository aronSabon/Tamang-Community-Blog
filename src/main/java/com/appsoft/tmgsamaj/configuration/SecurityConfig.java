...
@Autowired
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request
                .requestMatchers("/login", "/register","/css/**","/lemonCss/**", "/js/**", "/images/**","/vendors/**","/webjars/**","/","/assets/**","/f**", "/committeeMemberList1","/eventImages/**","/error","/payment","/homeSliderImages/**").permitAll() // allow access to these pages without authentication
